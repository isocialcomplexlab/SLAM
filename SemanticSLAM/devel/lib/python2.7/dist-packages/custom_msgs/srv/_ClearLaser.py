...
"""autogenerated by genpy from custom_msgs/ClearLaserRequest.msg. Do not edit."""
import codecs
import sys
...
class ClearLaserRequest(genpy.Message):
  _md5sum = "00cb7b8b21b02f60fc59fa03cb0dfb8d"
  _type = "custom_msgs/ClearLaserRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# svr for the ClearCells service
int8 weight
...
string frame_id
"""
  __slots__ = ['weight','laser']
  _slot_types = ['int8','sensor_msgs/LaserScan']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClearLaserRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_b3I().pack(_x.weight, _x.laser.header.seq, _x.laser.header.stamp.secs, _x.laser.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.weight, _x.laser.header.seq, _x.laser.header.stamp.secs, _x.laser.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_b3I():
    ...
    return _struct_b3I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from custom_msgs/ClearLaserResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ClearLaserResponse(genpy.Message):
  _md5sum = "b2fa35766f3759aa2164b5f04811b518"
  _type = "custom_msgs/ClearLaserResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float32 b
"""
  __slots__ = ['b']
  _slot_types = ['float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClearLaserResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.b is None:
        self.b = 0.
    else:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.b,) = _get_struct_f().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
def _get_struct_f():
    ...
    return _struct_f
class ClearLaser(object):
  _type          = 'custom_msgs/ClearLaser'
  _md5sum = 'f427fbbf8b1198bb81f85f08fbb4a779'
  _request_class  = ClearLaserRequest
  _response_class = ClearLaserResponse
